...
const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { foodId: "onigiri",    emoji: "🍙", label: "おにぎり",    portions: [{ label:"1個",   grams:100 },{ label:"2個",   grams:200 }] },
      ...
      { foodId: "rice_porridge",emoji:"🥣",label: "お粥",        portions: [{ label:"1杯",   grams:200 },{ label:"半分",  grams:100 }] },
      { foodId: "yakisoba",   emoji: "🍜", label: "焼きそば",    portions: [{ label:"1皿",   grams:200 },{ label:"半分",  grams:100 }] },
    ],
  },
  {
    name: "🥣 汁物",
    items: [
      ...
      { foodId: "tonjiru",      emoji: "🥣", label: "豚汁",           portions: [{ label:"全部飲んだ",grams:150 },{ label:"半分",grams:75 },{ label:"残した",grams:20 }] },
  ...
  },
  {
    ...
    items: [
      ...
      { foodId: "green_tea",      emoji: "🍵", label: "お茶（緑茶）",    portions: [{ label:"コップ1杯",grams:200 },{ label:"半分",grams:100 }] },
      { foodId: "barley_tea",     emoji: "🍵", label: "麦茶",            portions: [{ label:"コップ1杯",grams:200 },{ label:"半分",grams:100 }] },
      { foodId: "coffee",         emoji: "☕", label: "コーヒー",        portions: [{ label:"1杯",grams:150 },{ label:"大きめ",grams:250 }] },
      { foodId: "milk_latte",     emoji: "☕", label: "カフェラテ",      portions: [{ label:"1杯",grams:250 },{ label:"小さめ",grams:150 }] },
      { foodId: "soy_milk",       emoji: "🥛", label: "豆乳",            portions: [{ label:"1パック",grams:200 },{ label:"半分",grams:100 }] },
      { foodId: "orange_juice",   emoji: "🍊", label: "オレンジジュース",portions: [{ label:"1杯",grams:200 },{ label:"小さめ",grams:100 }] },
      { foodId: "fruit_juice",    emoji: "🍹", label: "100%果汁",        portions: [{ label:"1杯",grams:200 },{ label:"小さめ",grams:100 }] },
      { foodId: "vegetable_juice",emoji: "🥬", label: "野菜ジュース",    portions: [{ label:"1本",grams:200 },{ label:"半分",grams:100 }] },
      { foodId: "sports_drink",   emoji: "💧", label: "スポーツドリンク",portions: [{ label:"1本",grams:500 },{ label:"半分",grams:250 }] },
      { foodId: "cola",           emoji: "🥤", label: "コーラ",          portions: [{ label:"缶1本",grams:350 },{ label:"コップ1杯",grams:200 }] },
      { foodId: "carbonated_juice",emoji:"🥤", label: "炭酸ジュース",    portions: [{ label:"缶1本",grams:350 },{ label:"コップ1杯",grams:200 }] },
      { foodId: "cocoa",          emoji: "☕", label: "ココア",          portions: [{ label:"1杯",grams:200 },{ label:"小さめ",grams:150 }] },
      { foodId: "beer",           emoji: "🍺", label: "ビール",          portions: [{ label:"中ジョッキ",grams:350 },{ label:"缶1本",grams:350 },{ label:"小",grams:200 }] },
      { foodId: "sake",           emoji: "🍶", label: "日本酒",          portions: [{ label:"1合",grams:180 },{ label:"半合",grams:90 }] },
      { foodId: "shochu",         emoji: "🥃", label: "焼酎",            portions: [{ label:"1杯（水割り）",grams:100 },{ label:"ロック",grams:60 }] },
      { foodId: "wine_red",       emoji: "🍷", label: "赤ワイン",        portions: [{ label:"1杯",grams:120 },{ label:"半分",grams:60 }] },
      { foodId: "wine_white",     emoji: "🥂", label: "白ワイン",        portions: [{ label:"1杯",grams:120 },{ label:"半分",grams:60 }] },
      { foodId: "whisky",         emoji: "🥃", label: "ウイスキー",      portions: [{ label:"シングル",grams:30 },{ label:"ダブル",grams:60 }] },
    ],
  },
  {
    name: "🍖 肉類",
    items: [
      ...
      { foodId: "liver_chicken",emoji:"🍗",label: "鶏レバー",   portions: [{ label:"50g",    grams:50  },{ label:"100g",grams:100 }] },
      { foodId: "liver_pork", emoji: "🥩", label: "豚レバー",   portions: [{ label:"50g",    grams:50  },{ label:"100g",grams:100 }] },
    ],
    showRiskLegend: true,
  },
  {
    ...
    items: [
      ...
      { foodId: "cod",          emoji: "🐟", label: "たら",        portions: [{ label:"1切れ",grams:80  },{ label:"2切れ",grams:160 }] },
      { foodId: "shrimp",       emoji: "🦐", label: "えび",        portions: [{ label:"5尾",  grams:80  },{ label:"10尾", grams:160 }] },
      { foodId: "squid",        emoji: "🦑", label: "いか",        portions: [{ label:"1/2杯",grams:80  },{ label:"1杯",  grams:160 }] },
      { foodId: "scallop",      emoji: "🐚", label: "ほたて",      portions: [{ label:"2個",  grams:80  },{ label:"4個",  grams:160 }] },
      { foodId: "canned_mackerel",emoji:"🐟",label:"さば缶",       portions: [{ label:"1/2缶",grams:95  },{ label:"1缶",  grams:190 }] },
      { foodId: "canned_tuna",  emoji: "🐟", label: "ツナ缶",      portions: [{ label:"1/2缶",grams:70  },{ label:"1缶",  grams:140 }] },
  ...
  },
  {
    ...
    items: [
      ...
      { foodId: "abura_age",emoji: "🟡", label: "油揚げ",  portions: [{ label:"1枚",    grams:30  },{ label:"2枚",    grams:60  }] },
      { foodId: "atsuage",  emoji: "⬜", label: "厚揚げ",  portions: [{ label:"1/2個",  grams:100 },{ label:"1個",    grams:200 }] },
      { foodId: "edamame",  emoji: "🫛", label: "枝豆",    portions: [{ label:"ひとつまみ",grams:50},{ label:"多め",   grams:100 }] },
    ],
  },
  {
    name: "🥦 野菜",
    items: [
      ...
      { foodId: "chinese_cabbage",emoji:"🥬", label: "白菜",        portions: [{ label:"1皿",   grams:80  },{ label:"たっぷり",grams:150 }] },
      ...
      { foodId: "asparagus",     emoji: "🌿", label: "アスパラガス",portions: [{ label:"3本",   grams:60  },{ label:"5本",     grams:100 }] },
    ],
    showRiskLegend: true,
  },
  {
    ...
    items: [
      ...
      { foodId: "pineapple",   emoji: "🍍", label: "パイナップル",portions: [{ label:"1切れ",grams:80  },{ label:"2切れ",grams:160 }] },
      { foodId: "persimmon",   emoji: "🍊", label: "柿",          portions: [{ label:"1個",  grams:160 },{ label:"半分", grams:80  }] },
    ],
    showRiskLegend: true,
  },
  {
    ...
    items: [
      ...
      { foodId: "tamagoyaki",   emoji: "🥚", label: "玉子焼き",   portions: [{ label:"1切れ",grams:50  },{ label:"2切れ",grams:100 }] },
      ...
      { foodId: "yakitori",     emoji: "🍗", label: "焼き鳥",     portions: [{ label:"2本",  grams:60  },{ label:"4本",  grams:120 }] },
      { foodId: "gyudon",       emoji: "🍚", label: "牛丼",       portions: [{ label:"1杯",  grams:300 },{ label:"半分", grams:150 }] },
      { foodId: "oyakodon",     emoji: "🍚", label: "親子丼",     portions: [{ label:"1杯",  grams:300 },{ label:"半分", grams:150 }] },
      { foodId: "niku_jaga",    emoji: "🥘", label: "肉じゃが",   portions: [{ label:"1皿",  grams:150 },{ label:"半分", grams:75  }] },
      { foodId: "sushi_nigiri", emoji: "🍣", label: "にぎり寿司", portions: [{ label:"2貫",  grams:60  },{ label:"5貫",  grams:150 }] },
      { foodId: "tempura_shrimp",emoji:"🍤", label: "エビ天ぷら", portions: [{ label:"2本",  grams:70  },{ label:"3本",  grams:105 }] },
      { foodId: "chawanmushi",  emoji: "🥚", label: "茶碗蒸し",   portions: [{ label:"1個",  grams:150 },{ label:"半分", grams:75  }] },
    ],
  ...
  },
  {
    ...
    items: [
      ...
      { foodId: "kamaboko",        emoji: "🐟", label: "かまぼこ",     portions: [{ label:"2切れ",grams:40 },{ label:"4切れ",grams:80 }] },
      { foodId: "chikuwa",         emoji: "🟡", label: "ちくわ",       portions: [{ label:"1本",grams:30 },{ label:"2本",grams:60 }] },
      { foodId: "hanpen",          emoji: "⬜", label: "はんぺん",     portions: [{ label:"1/2枚",grams:55 },{ label:"1枚",grams:110 }] },
      { foodId: "instant_noodles", emoji: "🍜", label: "インスタント麺",portions: [{ label:"1袋",grams:100 }] },
      { foodId: "satsuma_age",     emoji: "🟠", label: "さつま揚げ",   portions: [{ label:"1枚",grams:60 },{ label:"2枚",grams:120 }] },
    ],
  ...
  },
  {
    ...
    items: [
      ...
      { foodId: "mayonnaise",   emoji: "🟡", label: "マヨネーズ",    portions: [{ label:"小さじ1",grams:5   },{ label:"大さじ1",grams:15 }] },
      { foodId: "ketchup",      emoji: "🍅", label: "ケチャップ",    portions: [{ label:"小さじ1",grams:5   },{ label:"大さじ1",grams:15 }] },
      { foodId: "worcestershire",emoji:"🟤", label: "ウスターソース",portions: [{ label:"小さじ1",grams:5   },{ label:"大さじ1",grams:15 }] },
      { foodId: "vinegar",      emoji: "🫙", label: "酢",            portions: [{ label:"小さじ1",grams:5   },{ label:"大さじ1",grams:15 }] },
      { foodId: "dressing",     emoji: "🥗", label: "ドレッシング",  portions: [{ label:"小さじ2",grams:10  },{ label:"大さじ1",grams:15 }] },
      ...
      { foodId: "butter",       emoji: "🟡", label: "バター",        portions: [{ label:"5g",     grams:5   },{ label:"10g",    grams:10  }] },
    ],
  },
];
...
function FoodButton({ btn, onTap, disabled }: { btn: FoodBtn; onTap: () => void; disabled?: boolean }) {
  ...
  return (
    ...
    >
      ...
      <span style={{ fontSize: 38, lineHeight: 1 }}>{btn.emoji}</span>
    ...
    <>
      ...
      <div style={{
        ...
        <div style={{ textAlign: "center", marginBottom: 20 }}>
          <div style={{ fontSize: 48 }}>{btn.emoji}</div>
